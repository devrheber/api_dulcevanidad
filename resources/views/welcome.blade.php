...
<head>
    ...
    <title>
        ...
        @yield('title', config('adminlte.title', 'Dulce Vanidad'))
...
<body class="@yield('classes_body')" @yield('body_data')>
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-center"><button type="button" class="btn btn-success p-3 btn-block">BIENVENID@S</button></div>
